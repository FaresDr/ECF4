...
public class JobOfferController {
    ...
    @GetMapping("/joboffer/appointenement/delete/{idrdv}")
    public String deleteRdv(@PathVariable("idrdv") Long idrdv){
        appointementService.delete(appointementService.findById(idrdv));
        return "redirect:/joboffer";
    }
}
